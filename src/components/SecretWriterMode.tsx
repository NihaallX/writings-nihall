        ...
        <ul className="list-disc list-inside text-left space-y-2">
          <li>
            ...
            <div className="prose prose-invert text-white/90 max-w-none">
              ...
              <br /><br />
              But then, I did something <strong>dumb.</strong> Out of desperation, I texted her, <em>“Send me the pics of the biryani you showed me.”</em> And she <strong>left me on sent.</strong>
              <br /><br />
